    ...
    <div class="col-lg-8 col-xl-6">
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                <h2 class="h5 fw-bold text-success mb-3">Create Admin Account</h2>
                <p class="text-muted small">Admins can access the admin dashboard, manage farmers, customers, products, and view orders, but cannot manage other administrators.</p>
