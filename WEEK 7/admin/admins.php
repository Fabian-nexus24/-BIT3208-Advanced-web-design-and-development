                ...
                <?php foreach ($admins as $ad): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <span class="badge bg-info text-dark"><i class="bi bi-shield-check me-1"></i>Manager</span>
                            <?php endif; ?>
                        </td>
                        <td>
                                ...
                                <?php if (!$isAdminSelf): ?>
                                    ...
                                    <?php elseif ($ad['role'] === 'super_admin' && ($superAdminsCount > 1 || $ad['status'] !== 'active')): ?>
                                        <form action="<?= e(url('admin/admin_action.php')) ?>" method="POST" class="d-inline">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-outline-secondary" title="Demote to Manager" onclick="return confirm('Are you sure you want to demote this Super Admin to Manager?');">
